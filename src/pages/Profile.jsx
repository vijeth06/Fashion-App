            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="grid grid-cols-3 gap-6 mt-8">
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">12</div>
                  <div className="text-gray-400 text-sm">OUTFITS TRIED</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">5</div>
                  <div className="text-gray-400 text-sm">ORDERS PLACED</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">18</div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/20 border border-white/20 rounded-xl text-gray-900 placeholder-gray-600 focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white"
